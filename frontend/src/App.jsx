...
class App extends React.Component {
        ...
        fetch("/api/session/", {
            ...
            .then((data) => {
                ...
                if (data.isAuthenticated) {
                    this.setState({ isAuthenticated: true, currentMenu: Menu.Home });
    ...
    downloadCompanyInfo = () => {
        fetch("/api/getCompanyInfo/", {
            ...
            .then((res) => res.json())
            .then((data) => {
                this.company_offer_info['company_long_name'] = data['company_long_name'];
    ...
    whoami = () => {
        fetch("/api/whoami/", {
            ...
            .then((data) => {
                ...
                document.getElementById("whoami_button").innerHTML = data.username;
            })
            .catch((err) => {
                console.log(err);
            });
    ...
    setCompanyDetailsOnPage = () => {
        document.getElementById("header-company-name").innerHTML = this.company_offer_info['company_long_name'];
    }
    ...
    login = (event) => {
        ...
        fetch("/api/login/", {
            ...
            .then((data) => {
                console.log(data);
                this.setState({ isAuthenticated: true, username: "", password: "", error: "", currentMenu: Menu.Home });
                this.downloadCompanyInfo();
            })
            .catch((err) => {
                console.log(err);
    ...
    switchMenuSettings = () => {
        this.setState({ currentMenu: Menu.Settings });
    };
    ...
    render() {
        ...
        // If user is authenticated - show his details
            ...
            if (this.state.currentMenu == Menu.Home) {
                return (
                    // <div className="container mt-3">
